...
<h1 class="textlogin">Meal History</h1>
...
?>
    <div class="buttons">
            <button class=" hero-buttons" formaction="../AddMeal/AddMeal.php">Add new meal</button>
    </div>
