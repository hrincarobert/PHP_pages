...
<div class="ServerRespose">
    ...
    <h1 class="textlogin">Add Child</h1>
    <form class="FormularInput" action = "childAdaugare.php" method = "post">
        ...
        <div class="buttons">
            <button class="hero-buttons" name="addChild" type = "submit" id = "sub" >Add Child</button>
        </div>
        <div class="buttons">
