...
<h1 class="textlogin">Change Child Info's</h1>
<div class="ServerRespose">
    ...
    <form class="FormularInput" action = "childInfoChange.php" method = "post">
        ...
        <div class="buttons">
            <button class="hero-buttons" name="change" type = "submit" id = "sub" >Update Info's</button>
        </div>
